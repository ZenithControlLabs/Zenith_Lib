#ifndef ZENITH_INTERVAL_H
#define ZENITH_INTERVAL_H
...
static inline bool interval_resettable_run(uint32_t timestamp,
                                           uint32_t interval, bool reset) {
    static uint32_t last_time = 0;
    static uint32_t this_time = 0;
